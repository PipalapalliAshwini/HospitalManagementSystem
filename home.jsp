      ...
      <center>
         <table width=1000 border=5 >
            ...
            <TR >
               <TD>
                  <pre>
<dl  class="dropdown" style="left: 206px;position: absolute;" >
...
<dl style="position:absolute;left: 444px;top: 68px;width:150px;" class="dropdown">
  ...
  <dd id="two-ddcontent" onmouseover="cancelHide('two')" onmouseout="ddMenu('two',-1)">
    <ul>
      ...
      <li><a href="insurance.jsp" class="underline">PATIENT INSURANCE DETAILS</a></li>
    </ul>
  </dd>
</dl>
<dl style="position:absolute;left: 691px;top: 69px;width:100px;" class="dropdown">
...
<BR><BR><BR>
<dl class="dropdown"  style="position: relative;left: 16px;">
...
<dl  class="dropdown" style="position: relative;left: 40px;top: -13px;">
...
<dl  class="dropdown" style="position: relative;top: -27px;left: 74px;">
  <dt id="seven-ddheader" onmouseover="ddMenu('seven',1)" onmouseout="ddMenu('seven',-1)">INSURANCE</dt>
